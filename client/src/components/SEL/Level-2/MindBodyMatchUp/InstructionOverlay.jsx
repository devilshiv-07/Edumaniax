...
const InstructionOverlay = ({ onClose }) => {
  const pairs = [
    { clue: "Sweaty palms", meaning: "Nervous" },
    { clue: "Dry mouth", meaning: "Anxious" },
    { clue: "Yawning in class", meaning: "Tired" },
    { clue: "Headache", meaning: "Dehydrated" },
    { clue: "Butterflies in stomach", meaning: "Excited" },
    { clue: "Fast heartbeat", meaning: "Scared" },
  ];
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Format:{" "}
                <span className="text-yellow-400">Timed Match Game</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  ⏱️ You have 90 seconds to match all body clues.
                </motion.li>
                <li>
                  🧠 Match each{" "}
                  <span className="text-green-300">physical sign</span> with the{" "}
                  <span className="text-green-300">feeling</span> it signals.
                </li>
                <li>✅ Get all 6 correct to win the challenge!</li>
              </ul>
            </div>
            ...
            >
              ...
              <div>
                Strengthen{" "}
                <span className="text-yellow-200">emotional awareness</span> by
                noticing how{" "}
                <span className="text-yellow-200">body signals</span> connect to
                feelings.
              </div>
            </motion.div>
          </div>
