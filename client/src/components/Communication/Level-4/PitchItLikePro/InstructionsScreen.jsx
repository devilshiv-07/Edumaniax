...
// For hiding the scrollbar while keeping the functionality
...
const InstructionsScreen = ({ onStartGame }) => {
  return (
    // --- CHANGED HERE: Added `overflow-y-auto`, `justify-start`, and `no-scrollbar` ---
    <div className="fixed inset-0 bg-[#0A160E]/80 flex flex-col items-center justify-start z-50 p-4 overflow-y-auto no-scrollbar">
      <style>{scrollbarHideStyle}</style>
      
      {/* Added some top margin (my-8) to the box to prevent it from sticking to the top edge */}
      <div className="relative w-full max-w-6xl lg:w-[90vw] h-auto my-8 bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-08-07/WxAZj0TxFZ.png)] bg-cover bg-no-repeat flex flex-col items-center py-16 px-4 md:px-10 ">
