      ...
      <div className="relative bg-[#0e341d] shadow-xl w-[95%] md:w-[1000px] text-white z-10 border border-gray-700 max-h-[90vh] overflow-y-auto md:overflow-visible p-4 sm:p-6">
        ...
        <div className="flex justify-center items-center bg-[#28343A] px-5 py-3 border-b border-gray-700">
          <h2 className="text-xl sm:text-2xl md:text-3xl lilita-one-regular font-bold text-white">
            Innovation Sprint – Leading Change & Innovation
          </h2>
        </div>
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              <p className="font-bold text-green-300">
                Idea Creator – Fill these fields:
              </p>
              <ul className="space-y-2 text-white">
                <li>✏️ What needs to change?</li>
                <li>💡 Why is it important?</li>
                <li>🚀 What is your new idea?</li>
              </ul>
            </motion.div>
                ...
                {checklist.map((item, index) => (
                  <motion.li
                    ...
                    transition={{
                      ...
                      repeat: Infinity,
                      ease: "easeInOut",
                      delay: index * 0.3, // stagger for cool wave effect
                    }}
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p className="text-lg font-bold text-yellow-400 mb-2">
                Module: Leading Change & Innovation
              </p>
              <p>
                <span className="text-green-400">Badge Earned:</span> ⚡ Change
                Maker
              </p>
              <p className="mt-3">
                <span className="text-green-400">Format:</span> Idea Creator +
                Feedback Tool
              </p>
              ...
              <ul className="list-decimal list-inside ml-3 mt-1">
                ...
                <li>Fill in the 3 idea fields.</li>
                <li>Check against the Innovation Checklist.</li>
                <li>Submit your idea + name your change project.</li>
                <li>Bonus: Add a sketch or slogan!</li>
              </ul>
            </div>
            ...
            >
              ...
              <div>
                🎨 Create your own{" "}
                <span className="text-green-900">Change Project</span>! Fill in
                your answers, give it a name, and share with your class. Extra
                points if you add a sketch or a catchy slogan!
              </div>
            </motion.div>
          </div>
        </div>
