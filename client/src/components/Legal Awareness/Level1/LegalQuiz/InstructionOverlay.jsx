      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              LawQuest: The Legal Adventure (MCQ Edition)
            </motion.h2>
            ...
            <div className="bg-[#0d1b1e] rounded-lg p-4 shadow-md text-left">
              ...
              <p className="text-gray-200 mt-2">
                Which article of the Indian Constitution guarantees the Right to
                Equality?
              </p>
            ...
            >
              <p className="font-bold mb-2 text-white">⭐ Immediate Feedback</p>
              <p className="text-gray-300 text-sm">
                See instantly if you’re right or wrong — no waiting!
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              ...
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">⚖️ Law Quiz Master</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🖱️ Answer 6 Multiple Choice Questions
                </motion.li>
                <li>✅ Get instant feedback on each answer</li>
                <li>📊 Score points for correct responses</li>
                <li>🏅 Win your badge with 50+ points!</li>
              </ul>
            </div>
            ...
            >
              ...
              <div>
                Strengthen your{" "}
                <span className="text-yellow-200">understanding of law</span> by
                practicing multiple-choice questions with instant feedback.
              </div>
            </motion.div>
          </div>
        </div>
