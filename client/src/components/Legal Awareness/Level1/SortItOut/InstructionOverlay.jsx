      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Sort legal statements into the correct category!
            </motion.h2>
            ...
            >
              <p className="font-bold mb-2 text-white">
                ⏱️ Timer + Bonus Points
              </p>
              <p className="text-gray-300 text-sm">
                Finish faster to score extra points!
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              ...
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">⚖️ Law Sorter Pro</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🖱️ Drag statements into the correct category
                </motion.li>
                <li>
                  📂 Categories: Fundamental Rights, Cyber Law, Consumer &
                  Environment
                </li>
                <li>⏱️ Beat the timer for bonus points</li>
                <li>🏅 Earn your badge with accurate sorting!</li>
              </ul>
            </div>
            ...
            >
              ...
              <div>
                Strengthen your{" "}
                <span className="text-yellow-200">knowledge of law</span> by
                quickly recognizing rights and legal protections.
              </div>
            </motion.div>
          </div>
        </div>
