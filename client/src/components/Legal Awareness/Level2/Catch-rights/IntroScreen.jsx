  ...
  return (
    <div className="w-full -mt-8 h-screen relative overflow-hidden">
      ...
      <button
        ...
        className="absolute mt-10 top-4 left-4 w-[82px] h-[48px] sm:w-[120px] sm:h-[64px] md:w-[202px] md:h-[82px] transition transform active:scale-95 z-50"
      >
        <img
          src={btnExit}
          alt="Exit"
      ...
      <button
        onClick={toggleAudio}
        className="absolute mt-10 top-4 right-4 w-[82px] h-[48px] sm:w-[120px] sm:h-[64px] md:w-[202px] md:h-[82px] transition-transform active:scale-95 z-50"
      >
        <img
          src={btnAudio}
          alt="Audio"
      ...
      <div className="relative z-10 text-center flex flex-col items-center justify-start sm:justify-center mt-10 sm:mt-0">
        <h1
          ...
          style={{
            textShadow: `-2px -2px 0 #000, 2px -2px 0 #000, -2px  2px 0 #000, 2px  2px 0 #000, -2px  0px 0 #000, 2px  0px 0 #000, 0px -2px 0 #000, 0px  2px 0 #000, 0px  4px 3px rgba(0,0,0,0.7)`,
          }}
        >
          The Law Connector
        </h1>
