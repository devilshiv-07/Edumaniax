      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              ⚖️ Catch Your Rights – Drag & Drop Challenge
            </motion.h2>

            {/* Demo Falling Item */}
            <div className="bg-[#0d1b1e] rounded-lg p-4 shadow-md text-left">
              ...
              <div className="flex justify-around mt-4">
                <div className="bg-[#1a2a2e] px-3 py-2 rounded-md text-sm text-gray-200">
              ...
              <p className="mt-3 text-yellow-400 text-xs">
                ✅ Drag the statement into the correct category!
              </p>
            </div>
            ...
            >
              <p className="font-bold mb-2 text-white">⭐ Scoring & Lives</p>
              <p className="text-gray-300 text-sm">
                +3 points for correct drop, -2 points & lose 1 ❤️ for wrong
                drop. Game over if lives hit 0!
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🪂 Catch falling legal statements
                </motion.li>
                <li>🖱️ Drag & drop into the correct law category</li>
                <li>⭐ Earn points & keep your lives safe</li>
                <li>🔥 Build streaks to unlock power-ups!</li>
              </ul>
            </div>
            ...
            >
              ...
              <div>
                Strengthen your{" "}
                <span className="text-yellow-200">legal awareness</span> by
                practicing rights & laws in a fun drag-and-drop format!
              </div>
            </motion.div>
          </div>
        </div>
