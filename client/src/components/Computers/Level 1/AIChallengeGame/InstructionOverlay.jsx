...
const InstructionOverlay = ({ onClose }) => {
  const tools = ["📥 AI Discovery Chart"];
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            <p className="text-gray-200 text-sm sm:text-base mb-4">
              ...
              AI is everywhere — in phones, games, even refrigerators! But do
              you notice it?
            </p>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                Look around your home and school. Complete the{" "}
                <span className="text-yellow-300 font-semibold">
                  AI Discovery Chart
                </span>{" "}
                by finding <b>5 places/devices</b>, explaining what they do, and
                checking if they’re smart!
              </p>
            </motion.div>
            ...
            <div className="mt-6 text-left bg-[#0d1b1e] p-4 rounded-lg">
              ...
              <ul className="list-disc list-inside text-gray-300 text-sm mt-2 space-y-1">
                <li>Which AI tool do you use the most?</li>
                <li>Which one surprises you the most?</li>
                <li>Can you live without AI for a day? Why or why not?</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module: <span className="text-yellow-400">AI Awareness</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🏆 AI Spotter</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  👀 Look around at school, home, or your surroundings
                </motion.li>
                <li>📥 Fill in the AI Discovery Chart for 5 items</li>
                <li>💡 Explain how each device/tool is smart</li>
                <li>🧑‍🏫 Answer reflection questions at the end</li>
                <li>🏅 Earn your AI Spotter badge!</li>
              </ul>
            </div>
