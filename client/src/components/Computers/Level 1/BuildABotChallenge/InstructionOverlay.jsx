        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                ...
                to design your dream AI bot! Fill in its{" "}
                <b>
                  Name, Purpose, Who it Helps, What it Learns, Catchy Phrase
                </b>
                , Sketch or Description, and don’t forget its{" "}
                <b>Special Power</b>.
              </p>
            </motion.div>
            ...
            <div className="mt-6 text-left bg-[#0d1b1e] p-4 rounded-lg">
              ...
              <ul className="list-disc list-inside text-gray-300 text-sm mt-2 space-y-1">
                <li>How does your AI machine make life easier or better?</li>
                <li>What makes your AI unique compared to existing ones?</li>
                <li>
                  If you could build it in real life, what would you improve
                  first?
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module: <span className="text-yellow-400">AI Creativity</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🏆 Bot Builder</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🧑‍🔬 Imagine a new AI machine
                </motion.li>
                <li>📥 Fill in the AI Creator Canvas with details</li>
                <li>🎨 Sketch or describe how your AI looks</li>
                <li>💡 Give it a special power that stands out</li>
                <li>🏅 Earn your Bot Builder badge!</li>
              </ul>
            </div>
