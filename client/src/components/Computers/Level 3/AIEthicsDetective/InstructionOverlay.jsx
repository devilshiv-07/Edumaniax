...
const InstructionOverlay = ({ onClose }) => {
  const tools = ["📊 AI Ethics Table", "📝 Reflection Sheet"];
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Mission: Explore the Right and Wrong of AI 🎯
            </motion.h2>
            ...
            <p className="text-gray-200 text-sm sm:text-base mb-4">
              ...
              AI can help or harm people. We need to use it responsibly!
            </p>
            ...
            >
              ...
              <table className="w-full border border-gray-600 rounded-lg text-left text-xs sm:text-sm">
                <thead>
                  <tr className="bg-[#0d1b1e] text-yellow-300">
                    ...
                    <th className="px-2 py-1 border border-gray-600">Why?</th>
                    <th className="px-2 py-1 border border-gray-600">
                ...
                <tbody>
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      AI that recognizes faces for school security
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
                  ...
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      AI that decides who gets a job
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
                  ...
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      AI that suggests what you should buy
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
                  ...
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      AI that helps doctors diagnose diseases
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
              ...
              <div className="mt-4 text-gray-300 text-sm">
                <p className="font-bold mb-1">🧠 Deep Thinking Questions:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li>Should AI make decisions about people's lives?</li>
                  <li>How can we prevent AI bias?</li>
                  <li>What rules should AI follow?</li>
                </ul>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module:{" "}
                <span className="text-yellow-400">AI Ethics Detective</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🕵️‍♂️ Ethics Explorer</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  📝 Judge if the AI is Helpful or Harmful
                </motion.li>
                <li>💡 Explain why</li>
                <li>🔧 Suggest how to make it better</li>
                <li>🧠 Answer deep thinking questions</li>
                <li>🏅 Earn your Ethics Explorer badge!</li>
              </ul>
            </div>
