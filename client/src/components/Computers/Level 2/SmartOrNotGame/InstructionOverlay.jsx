      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Mission: What Can AI Do (and Not Do)? 🎯
            </motion.h2>
            ...
            <p className="text-gray-200 text-sm sm:text-base mb-4">
              ...
              Some tasks are easy for AI. Others are still too human!
            </p>
            ...
            >
              ...
              <table className="w-full border border-gray-600 rounded-lg text-left text-xs sm:text-sm">
                <thead>
                  <tr className="bg-[#0d1b1e] text-yellow-300">
                    <th className="px-2 py-1 border border-gray-600">Task</th>
              ...
              <div className="mt-4 text-gray-300 text-sm">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>What makes some tasks harder for AI?</li>
                  <li>Which human abilities are unique?</li>
                </ul>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module: <span className="text-yellow-400">Smart or Not?</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🕵 AI Detective</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🧩 Drag & drop tasks under the right AI capability
                </motion.li>
                <li>📥 Discuss why each task is easy or hard for AI</li>
                <li>💡 Explore critical thinking questions</li>
                <li>🏅 Earn your AI Detective badge!</li>
              </ul>
            </div>
