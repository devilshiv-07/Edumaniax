...
const InstructionOverlay = ({ onClose }) => {
  const tools = ["📊 AI Task Analysis Table", "📝 Problem Radar Sheet"];
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Mission: Use AI to Solve Real Problems 🎯
            </motion.h2>
            ...
            <p className="text-gray-200 text-sm sm:text-base mb-4">
              ...
              AI can help solve problems in school, home, and community.
            </p>
            ...
            >
              ...
              <p className="text-gray-300 text-sm mb-4">
                Design AI solutions for these scenarios:
              </p>
                ...
                <tbody>
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      School: Students struggle with math homework
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
                  ...
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      Home: Elderly grandparents feel lonely
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
                  ...
                  <tr>
                    <td className="px-2 py-1 border border-gray-600">
                      Community: Traffic jams in the city
                    </td>
                    <td className="px-2 py-1 border border-gray-600">
                      ___________
                    </td>
              ...
              <div className="mt-4 text-gray-300 text-sm">
                <p className="font-bold mb-1">💡 Critical Thinking:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    How can AI make life easier at school, home, and in the
                    city?
                  </li>
                  <li>Which problems need human + AI teamwork?</li>
                </ul>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module:{" "}
                <span className="text-yellow-400">AI Problem Solver</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🛠️ Problem Solver</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                ...
                <li>💡 Suggest an AI solution</li>
                <li>🤝 Explain how it helps people</li>
                <li>🏅 Earn your Problem Solver badge!</li>
              </ul>
            </div>
