...
const InstructionsScreen = ({ onStartGame }) => {
  return (
    ...
    <p className="mb-2">🧩 Step into the role of the newly elected School Council Vice-Captain!</p>
    <p className="mb-2">🎯 Your Task:</p>
    <ul className="list-disc list-inside mb-2 pl-4">
      <li>Compose a 5–6 line broadcast message to your team</li>
      <li>Acknowledge delays or challenges</li>
      <li>Appreciate your team’s efforts</li>
      <li>Give clear next steps with a motivating tone</li>
      <li>Select the communication style: Assertive, Aggressive, or Passive</li>
    </ul>
    <p className="mb-2">⏰ You’ll have ~8 minutes to complete the challenge!</p>
            </div>
            ...
            <div className="w-full max-w-sm mt-8 bg-yellow-500 bg-cover bg-no-repeat p-4 rounded-lg text-white">
              ...
              <span className="block mt-1 font-sans text-sm md:text-base leading-snug">
                Communicate with clarity, confidence, and direction in leadership scenarios
              </span>
            </div>
          </div>
