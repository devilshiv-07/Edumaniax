...
const scenarioData = {
    ...
    options: [
            "Urea gives a quick crop boost – every farmer swears by it!",
            "Long-term soil health? Urea is a magic fix!",
            "It’s the only fertilizer accessible in rural markets.",
            "Urea is eco-friendly and natural, right?",
        ],
};
    ...
    return (
        ...
        <div className="w-full h-auto bg-[#00260d] rounded-lg border border-[#f2f4f6] flex flex-col md:flex-row p-4 gap-2">
            ...
            <div className="w-full max-w-4xl bg-gray-800/30 rounded-xl p-6 md:p-6">
                <div className="flex flex-col justify-center items-center gap-2 text-start">
