// src/components/Games/CauseEffectGame/BottomProgressLoader.jsx
...
const BottomProgressLoader = ({ onComplete }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 bg-[rgba(40,52,58,0.20)] border-t border-white/20 backdrop-blur-sm text-white pt-2 pb-4 px-4 lilita [text-shadow:0_4px_0_#000] [text-stroke:1px_black] tracking-[0.05vw]">
      {/* TIP Heading */}
      <div className="text-center text-lg sm:text-xl md:text-2xl ">TIP:</div>

      {/* Tip Content */}
      <div className="text-center text-sm sm:text-base md:text-lg mb-2">
        Everything on Earth is connected. Think about how one action can affect the land, air, and water.
      </div>
