      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Build your own AI-based startup idea with purpose, features, and
              identity!
            </motion.h2>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                Design a business idea that uses{" "}
                <span className="text-yellow-300 font-semibold">
                  AI for good
                </span>
                . Give it a name, define its purpose, list key features, and
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              ...
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">💡 Startup Star</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🏷️ Choose a name for your startup
                </motion.li>
                <li>
                  📝 Write a short description of what it does and who it helps
                </li>
                <li>✨ List 3 key features your product will offer</li>
                <li>🤖 Mention the type(s) of AI your solution will use</li>
                <li>🎨 Design or upload a logo for your startup</li>
              </ul>
            </div>
