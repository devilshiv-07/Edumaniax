...
const InstructionOverlay = ({ onClose }) => {
  const tools = ["📝 Problem Radar Sheet", "📊 AI Match Table"];
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Spot problems around you and match them with AI superpowers!
            </motion.h2>

            {/* AI Categories Demo */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {["🤖 Robotics", "🧠 Prediction", "👀 Vision", "💬 Language"].map(
                (cat, idx) => (
                  <motion.div
                    key={idx}
                    animate={{ y: [0, -6, 0] }}
                  ...
                  >
                    <p className="text-green-300 font-bold">{cat}</p>
                    <p className="text-gray-300 text-sm mt-2">
                      Link problems to this AI type
                    </p>
                  </motion.div>
                )
              )}
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                ...
                and pair them with the right AI solution.
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              <p>
                Module: <span className="text-yellow-400">AI & Innovation</span>
              </p>
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🚀 Innovation Explorer</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🔍 Spot 5 everyday problems (school, home, environment…)
                </motion.li>
                <li>⚡ Match each problem to an AI type</li>
                <li>💡 Write a short creative AI-powered solution</li>
                <li>🏅 Complete all 5 to earn your badge!</li>
              </ul>
            </div>
