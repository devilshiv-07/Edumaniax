...
const InstructionOverlay = ({ onClose }) => {
  const tools = [
    "🖼️ MVP Mockup Template (use Canva or Drawings)",
    "🧪 Test Plan Form",
    "📋 Simulated User Feedback Cards",
  ];
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="w-full lg:-ml-6 max-w-5xl mx-auto border border-[#F3F4F6] rounded-xl p-6 bg-[#00260E] order-2 lg:order-1 text-center">
            ...
            >
              Welcome to the{" "}
              <span className="text-yellow-300">MVP Test Lab!</span>
            </motion.h2>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                Simulate your product idea, test it, and{" "}
                <span className="text-yellow-300 font-semibold">
                  make smart changes!
                </span>{" "}
                Before launching a big product, startups build an MVP (Minimum
                Viable Product) to check if users like the core idea. This
                challenge helps you test your startup idea using{" "}
                <span className="text-yellow-300 font-semibold">
                  quick, low-cost methods.
                </span>
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:w-1/2 gap-4 order-1 lg:order-2">
            <div className="text-gray-200 lilita-one-regular leading-snug text-xs sm:text-sm lg:text-base text-left">
              ...
              <p>
                Badge Earned:{" "}
                <span className="text-green-400">🏅 MVP Tester</span>
              </p>
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                <motion.li
                  ...
                  transition={{ repeat: Infinity, duration: 2 }}
                >
                  🖼️ Create a simple mockup of your product (sketch, slide, or
                  screenshot)
                </motion.li>
                <li>
                  🧪 Write a short test plan (what will you ask users? what are
                  you testing?)
                </li>
                <li>
                  📋 Simulate user feedback (based on scenarios or peer
                  comments)
                </li>
                <li>📝 Write 3 improvements you’d make from the feedback</li>
              </ul>
            </div>
