...
import Section2dm from "./LegalAwareness/Module2";
import Section3dm from "./LegalAwareness/Module3";
...
import Module3 from "./LegalAwareness/9-10Section3";
import Module4 from "./LegalAwareness/9-10Section4";
import Module5 from "./LegalAwareness/9-10Section5";

import Senior1 from "./LegalAwareness/11-12Section1";
import Senior2 from "./LegalAwareness/11-12Section2";
import Senior3 from "./LegalAwareness/11-12Section3";
import Senior4 from "./LegalAwareness/11-12Section4";
...
const notesSidebar6to8 = [
  { id: "1", title: "Module 1: Intorduction" },
  { id: "2", title: "Module 2: Constitution" },
  { id: "3", title: "Module 3: Law for childern" },
  { id: "4", title: "Module 4: Law in Daily Life" },
  { id: "5", title: "Module 5: Law for Digital world" },
  { id: "6", title: "Module 6: Courts, Justice, and You" },
];

const notesSidebar9to10 = [
  { id: "m-1", title: "Module 1: Introduction" },
  { id: "m-2", title: "Module 2: Structure and Nature" },
  { id: "m-3", title: "Module 3: Law-Making" },
  { id: "m-4", title: "Module 4: Cyber Laws" },
  { id: "m-5", title: "Module 5: International Law" },
];

const notesSidebar11to12 = [
  { id: "s-1", title: "Module 1: Introduction" },
  { id: "s-2", title: "Module 2: Law of Torts" },
  { id: "s-3", title: "Module 3: Criminal Law" },
  { id: "s-4", title: "Module 4: Law of Contracts" },
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-50">
                    {gradeOptions.map((option) => (
                      <button
                        ...
                        className="w-full px-6 py-3 text-left text-gray-800 hover:bg-green-50 border-b last:border-b-0"
                      >
                        {option.label}
                      </button>
                    ))}
