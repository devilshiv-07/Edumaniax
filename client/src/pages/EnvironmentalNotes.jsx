...
const notesSidebar9to10 = [
  ...
  { id: "m-2", title: "Module 2: Unsustainable Growth" },
  { id: "m-3", title: "Module 3: Global Action" },
  { id: "m-4", title: "Module 4: Cities and Tech" },
  { id: "m-5", title: "Module 5: Water Management" },
];
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
                <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">
                  Discover how our choices impact ecosystems, cities, oceans, and climate
                </span>
              </h2>

              <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
                Let’s learn to grow with nature, not against it
              </p>
