...
import Section1dm from "../FinanceDesignForNotes/6-8Section1";
import Section2dm from "../FinanceDesignForNotes/6-8Section2";
import Section3dm from "../FinanceDesignForNotes/6-8Section3";
import Section4dm from "../FinanceDesignForNotes/6-8Section4";
import Section5dm from "../FinanceDesignForNotes/6-8Section5";
import Section6dm from "../FinanceDesignForNotes/6-8Section6";


import Module1 from "../FinanceDesignForNotes/9-10Section1";
import Module2 from "../FinanceDesignForNotes/9-10Section2";
import Module3 from "../FinanceDesignForNotes/9-10Section3";
import Module4 from "../FinanceDesignForNotes/9-10Section4";
import Module5 from "../FinanceDesignForNotes/9-10Section5";
import Module6 from "../FinanceDesignForNotes/9-10Section6";
import Module7 from "../FinanceDesignForNotes/9-10Section7";


import Senior1 from "../FinanceDesignForNotes/9-10Section1";
import Senior2 from "../FinanceDesignForNotes/9-10Section2";
import Senior3 from "../FinanceDesignForNotes/9-10Section3";
import Senior4 from "../FinanceDesignForNotes/9-10Section4";
import Senior5 from "../FinanceDesignForNotes/9-10Section5";
import Senior6 from "../FinanceDesignForNotes/9-10Section6";
import Senior7 from "../FinanceDesignForNotes/9-10Section7";
...
const notesSidebar6to8 = [
  { id: "1", title: "Section 1: Basics of Banking" },
  { id: "2", title: "Section 2: Budgeting 101" },
  { id: "3", title: "Section 3: What Is Credit" },
  { id: "4", title: "Section 4: Stock Market" },
  { id: "5", title: "Section 5: Investing " },
  { id: "6", title: "Section 6: Smart Spending " },

];

const notesSidebar9to10 = [
  { id: "m-1", title: "Module 1: Money & It's Value" },
  { id: "m-2", title: "Module 2: Saving & Budgeting" },
  { id: "m-3", title: "Module 3: Banking Basics" },
  { id: "m-4", title: "Module 4: Investing" },
  { id: "m-5", title: "Module 5: Stock Market" },
  { id: "m-6", title: "Module 6: Personal Finance" },
  { id: "m-7", title: "Module 7: Glossary" },
      ...
      {selectedGrade === "6-8" && (
        <div>
          ...
          <div className="flex h-[90vh] overflow-hidden relative pt-[4.5rem] md:pt-0">
            ...
            >
              <h2 className="text-xl font-bold text-green-800 mb-6 px-2">
                Finance
              ...
              <ul className="space-y-3">
                {notesSidebar11to12.map((section) => (
                  <li
                    ...
                    data-scroll-id={section.id}
                    className={`cursor-pointer px-3 py-2 rounded-lg transition-all duration-200 text-sm shadow-sm ${activeId === section.id
                        ? "bg-green-100 text-greeen-800 font-semibold border-l-4 border-green-500"
                        : "hover:bg-green-50 text-gray-800"
                      }`}
                    onClick={() => scrollTo(section.id)}
                  >
