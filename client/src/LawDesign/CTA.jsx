...
import { useAuth } from "../contexts/AuthContext"; // Adjust path if required
...
const CTA = () => {
  ...
  explore the world of law. With every lesson, they’ll take their first
  big steps toward understanding rights, responsibilities, and
  justice—without even realizing they’re learning!`;
